...
export default function ComponentIconDelete(props:Props){
    ...
    return (
        ...
        <IconDiv>
			<svg x="0px" y="0px" viewBox="0 0 24 24">
				<g>
					<IconPath d="M6.631,23.25c-1.161,0-2.146-0.906-2.242-2.064L3.06,5.25H1.5c-0.414,0-0.75-0.336-0.75-0.75S1.086,3.75,1.5,3.75h6V3
					...
					<IconPath d="M9.75,18C9.336,18,9,17.664,9,17.25v-7.5C9,9.336,9.336,9,9.75,9s0.75,0.336,0.75,0.75v7.5C10.5,17.664,10.164,18,9.75,18z
						"/>
					<IconPath d="M14.25,18c-0.414,0-0.75-0.336-0.75-0.75v-7.5C13.5,9.336,13.836,9,14.25,9S15,9.336,15,9.75v7.5
